...
<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="?ekle">
								 ...
								 <div class="form-group">
                                         <select name="depo">
												<?php
											$baglan = mysqli_connect($server, $username, $password, $database);
					...
					$guncelle=$stmt = mysqli_prepare($baglan, "INSERT INTO urunler (urunAdi,urunBarkod,urunStokKodu,urunAdet,Depo) values (?,?,?,?,?)");
                    mysqli_stmt_bind_param($stmt, "ssssi", $uadi, $barkod, $stokkodu, $adeti, $depo);
