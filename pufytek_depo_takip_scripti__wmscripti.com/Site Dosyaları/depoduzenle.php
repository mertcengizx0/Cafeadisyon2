...
$id = @$_GET['id'];
$icerik=mysqli_query($baglan,"select * from depolar where depoID = '$id'");		
...
<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="depolar.php" data-toggle="">Kategori Yönetimi</a>
                                </li>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="?duzenle">
								 ...
								 <div class="form-group">
                                            ...
                                            <input class="form-control" name="depo" type="text" value="<?="   ";?>">
                                 </div>
					...
					$guncelle=mysqli_query($baglan,"update depolar set depoAdi='$dadi' where depoID=$uid");	
if(isset($guncelle)){
