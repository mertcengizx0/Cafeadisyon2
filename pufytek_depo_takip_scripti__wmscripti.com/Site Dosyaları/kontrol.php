...
$sql_check = $sql_check = mysqli_query($baglan, "SELECT * from kullanicilar where kullaniciadi='".$kadi."' and sifre='".$sifre."' ") or die(mysqli_error($baglan));
