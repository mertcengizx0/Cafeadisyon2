...
<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                ...
                                <li class=""><a href="depolar.php" data-toggle="">Kategori Yönetimi</a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php
									$urunsql=mysqli_query($baglan,"select * from urunler");
									...
									echo	 '<tr class="odd gradeX">
                                            ...
                                            <td class="center">';
												$depocek=mysqli_query($baglan,"select * from depolar where depoID=$urun[5]");
...
if(isset($_GET['arti'])){
    ...
    $urunid=$_GET['uuid'];
    $toplam=(int)$adeti + (int)$adeti1;
    $islem=mysqli_query($baglan,"update urunler set urunAdet='$toplam' where urunID=$urunid");
